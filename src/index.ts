...
const nonSpamKeycodes = [
    16, 17, 18, 91, 93, 20, 27, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121,
    122, 123, 45, 46, 19, 144, 37, 38, 39, 40,
];
const validKeycodes = [
    ...
    93, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 109, 110, 111,
    112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 144, 145, 186,
    187, 188, 189, 190, 191, 192, 193, 194, 219, 220, 221, 222, 223, 224, 225,
...
export function stop(): void {
    ...
    document.body.removeChild(
        document.getElementById("osutype") as HTMLInputElement
    );
